...
SELECT *
FROM {{ env_var('DBT_SOURCE_DATABASE', 'APITDBDEV') }}.MASTER_DATA.EDW_MATERIALSALES
...
LEFT JOIN {{ env_var('DBT_SOURCE_DATABASE', 'APITDBDEV') }}.TRANSACTION_DATA.RTM_LEADTIME B
ON A.SAPCODE = B.RETAILCODE AND A.SPCODE = B.SERVICE_PROVIDER_CODE_WC
LEFT JOIN {{ env_var('DBT_SOURCE_DATABASE', 'APITDBDEV') }}.MASTER_DATA.EDW_PRODUCT c
